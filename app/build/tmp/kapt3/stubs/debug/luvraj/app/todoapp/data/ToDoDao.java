...
public abstract interface ToDoDao {
    ...
    public abstract androidx.lifecycle.LiveData<java.util.List<luvraj.app.todoapp.data.models.ToDoData>> searchDatabase(@org.jetbrains.annotations.NotNull()
    ...
    public abstract androidx.lifecycle.LiveData<java.util.List<luvraj.app.todoapp.data.models.ToDoData>> sortByHighPriority();
    ...
    public abstract androidx.lifecycle.LiveData<java.util.List<luvraj.app.todoapp.data.models.ToDoData>> sortByLowPriority();
}